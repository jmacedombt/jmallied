...
const TILES = [
  {
    href: "/usuarios",
    titulo: "Usuários",
    descricao: "Cadastro de usuários do sistema — cargo, permissões e pedidos de reset de senha.",
    icone: Users,
    cor: "#2563eb",
    clara: "#60a5fa",
  },
  {
    ...
    descricao: "Espaço em disco de cada tabela, zerar dados de implantação e compactar histórico antigo — tudo restrito a Administrador.",
    icone: HardDrive,
    cor: "#dc2626",
    clara: "#f87171",
  },
...
export default async function SistemaPage() {
  ...
  return (
    <AppShell titulo="Sistema" perfil={perfil}>
      <p className="text-sm mb-5" style={{ color: "var(--muted)" }}>
        Escolha uma opção de administração do sistema.
      </p>
